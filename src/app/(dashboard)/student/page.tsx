    ...
    <div style={{ padding:'16px 16px 8px' }}>
      ...
      <div style={{ background:`${phaseColor}10`, border:`1px solid ${phaseColor}35`, borderRadius:14, padding:16, marginBottom:12 }}>
        ...
        <div style={{ height:6, background:T.navy3, borderRadius:3 }}>
          <div style={{ height:'100%', borderRadius:3, background:`linear-gradient(90deg,${phaseColor},${T.indigoL})`, width:`${pct}%` }} />
        </div>
                ...
                {task.resource_url && !done && (
                  <div style={{ marginTop:3 }}>
                    <a href={task.resource_url} target="_blank" rel="noreferrer"
                      style={{ fontSize:11, color:T.indigo, textDecoration:'none' }}>🔗 Open →</a>
                  </div>
                )}
              </div>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:10, marginBottom:12 }}>
        <Link href="/student/curriculum" style={{ textDecoration:'none', display:'flex', alignItems:'center', gap:10, padding:'12px 14px',
          background:T.navy2, border:`1px solid ${T.border}`, borderRadius:12 }}>
        ...
        <Link href="/student/certs" style={{ textDecoration:'none', display:'flex', alignItems:'center', gap:10, padding:'12px 14px',
          background:T.navy2, border:`1px solid ${T.border}`, borderRadius:12 }}>
          <span style={{ fontSize:22 }}>🏆</span>
          <div>
        ...
        {[
          ...
          return (
            <div key={yr.yr} style={{ display:'flex', alignItems:'center', gap:12, marginBottom:10 }}>
              <div style={{ width:10, height:10, borderRadius:'50%', flexShrink:0, background: yearActive ? yr.color : T.border }} />
              <div style={{ flex:1 }}>
